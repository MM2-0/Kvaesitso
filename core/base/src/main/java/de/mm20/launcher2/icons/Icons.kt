...
private val _Stethoscope = materialSymbol("Icons.Rounded.Dentistry") {
    materialPath {
        moveTo(540f, -80f)
        ...
        reflectiveQuadTo(800f, -407f)
        verticalLineToRelative(67f)
        quadToRelative(0f, 108f, -76f, 184f)
        reflectiveQuadTo(540f, -80f)
        close()
    }
}
...
private val _Dentistry = materialSymbol("Icons.Rounded.Dentistry") {
    materialPath {
        moveTo(680f, 85f)
        quadTo(746f, 85f, 793f, 132f)
        quadTo(840f, 179f, 840f, 245f)
        quadTo(840f, 256f, 838.5f, 274.5f)
        quadTo(837f, 293f, 834f, 317f)
        lineTo(779f, 720f)
        quadTo(774f, 758f, 744.5f, 782f)
        quadTo(715f, 806f, 677f, 806f)
        quadTo(654f, 806f, 634.5f, 796f)
        quadTo(615f, 786f, 602f, 768f)
        lineTo(495f, 612f)
        quadTo(493f, 608f, 488.5f, 606.5f)
        quadTo(484f, 605f, 479f, 605f)
        quadTo(475f, 605f, 463f, 614f)
        lineTo(359f, 765f)
        quadTo(345f, 785f, 324.5f, 795.5f)
        quadTo(304f, 806f, 281f, 806f)
        quadTo(243f, 806f, 214f, 781.5f)
        quadTo(185f, 757f, 180f, 719f)
        lineTo(126f, 317f)
        quadTo(123f, 293f, 121.5f, 274.5f)
        quadTo(120f, 256f, 120f, 245f)
        quadTo(120f, 179f, 167f, 132f)
        quadTo(214f, 85f, 280f, 85f)
        quadTo(316f, 85f, 337.5f, 94.5f)
        quadTo(359f, 104f, 379f, 115f)
        quadTo(399f, 126f, 421.5f, 135.5f)
        quadTo(444f, 145f, 480f, 145f)
        quadTo(516f, 145f, 538.5f, 135.5f)
        quadTo(561f, 126f, 581f, 115f)
        quadTo(601f, 104f, 623f, 94.5f)
        quadTo(645f, 85f, 680f, 85f)
        close()
        moveTo(680f, 165f)
        quadTo(657f, 165f, 639.5f, 174.5f)
        quadTo(622f, 184f, 601f, 195f)
        quadTo(580f, 206f, 552f, 215.5f)
        quadTo(524f, 225f, 480f, 225f)
        quadTo(436f, 225f, 408f, 215.5f)
        quadTo(380f, 206f, 359f, 195f)
        quadTo(338f, 184f, 320.5f, 174.5f)
        quadTo(303f, 165f, 280f, 165f)
        quadTo(247f, 165f, 223.5f, 188.5f)
        quadTo(200f, 212f, 200f, 245f)
        quadTo(200f, 253f, 201f, 268f)
        quadTo(202f, 283f, 205f, 303f)
        lineTo(260f, 708f)
        quadTo(261f, 716f, 267f, 720.5f)
        quadTo(273f, 725f, 281f, 725f)
        quadTo(286f, 725f, 290f, 723f)
        quadTo(294f, 721f, 296f, 717f)
        lineTo(397f, 569f)
        quadTo(411f, 549f, 433f, 537f)
        quadTo(455f, 525f, 480f, 525f)
        quadTo(505f, 525f, 527f, 537f)
        quadTo(549f, 549f, 563f, 569f)
        lineTo(666f, 720f)
        quadTo(668f, 723f, 671f, 724.5f)
        quadTo(674f, 726f, 678f, 726f)
        quadTo(686f, 726f, 692.5f, 721.5f)
        quadTo(699f, 717f, 700f, 709f)
        lineTo(755f, 303f)
        quadTo(758f, 283f, 759f, 268f)
        quadTo(760f, 253f, 760f, 245f)
        quadTo(760f, 212f, 736.5f, 188.5f)
        quadTo(713f, 165f, 680f, 165f)
        close()
        moveTo(480f, 445f)
        quadTo(480f, 445f, 480f, 445f)
        quadTo(480f, 445f, 480f, 445f)
        quadTo(480f, 445f, 480f, 445f)
        quadTo(480f, 445f, 480f, 445f)
        lineTo(480f, 445f)
...
private val _Eyeglasses = materialSymbol("Icons.Rounded.Eyeglasses") {
    materialPath {
        moveTo(274f, -360f)
        ...
        reflectiveQuadTo(686f, -280f)
        quadToRelative(-57f, 0f, -102.5f, -32.5f)
        reflectiveQuadTo(520f, -399f)
