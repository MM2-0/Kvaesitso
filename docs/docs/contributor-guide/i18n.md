...
## Default language variants

- The base language is US American English (`en-US`)
- Spanish (`es`) is LATAM Spanish (`es-419`)
- Portuguese (`pt`) is European Portuguese (`pt-PT`)
    - For Brazilian Portuguese, see Portuguese (Brazil) (`pt-BR`)
- Arabic (`ar`) is Modern Standard Arabic
- French (`fr`) is French (France) (`fr-FR`)
- German (`de`) is German (Germany) (`de-DE`)
- Dutch (`nl`) is Dutch (Netherlands) (`nl-NL`)
- Swedish (`sv`) is Swedish (Sweden) (`sv-SE`)
...
**French**, **French (feminine)**, and **French (masculine)**.
